...
object StreamingRecommender {
  ...
  // kafka 集群的配置信息
  val KAFKA_URL = "192.168.87.152:9092"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf().setMaster(config("spark.cores")).setAppName("com.koi.bigdata.StreamingRecommender")
